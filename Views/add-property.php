              ...
              <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                  <span class="d-none d-sm-inline">
                    <a href="view-users.php" class="btn btn-white">
                      View Propertype
                    </a>
                  </span>
                </div>
                  ...
                  <form method="POST">
					...
					<div class="mb-3 col-md-6">
                      ...
                      <div class="mb-3 col-md-6">
						...
						<?php $types = $property->getPropertyTypes(); ?>
                    ...
                    <!-- <div class="row" style="margin-left: 1em; margin-right: 1em; margin-top:1em;">
                      <div class="mb-3 col-md-6">
                        ...
                        <select class="form-control" name="prop_type" id="">
                          <option value=""></option>
                        </select>
                      </div>
                      <div class="mb-3 col-md-6">
                    ...
                    <div class="row" style="margin-left: 1em; margin-right: 1em; margin-top:1em;">
                      ...
                      <div class="mb-3 col-md-6">
                        ...
                        <input type="text" class="form-control" name="property_desc" placeholder="Enter Property Description and Location">
                      </div>
                    </div>
                    <div class="row" style="margin-left: 1em; margin-right: 1em; margin-top:1em; margin-bottom:2em;">
                      	<div class="col-12 col-lg-6" id="hide">
							<div class="form-group">
                          	<?php if (empty($post)): ?>
								<label class="form-check">
                                	<input class="form-check-input" type="checkbox">
                                	<span class="form-check-label">Post Now</span>
                              	</label>
                            	<?php else: ?>
								<label class="form-check">
                    ...
                    <div class="card-footer text-end">
                      <div class="d-flex">
                        ...
                        <button type="submit" name="add-property" class="btn btn-primary ms-auto">Add Property</button>
                      </div>
                    </div>
                  </form>                  
                </div>
