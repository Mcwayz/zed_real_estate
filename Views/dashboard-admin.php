                ...
                <div class="card">
                  ...
                  <div class="table-responsive">
                    <table class="table card-table table-vcenter text-nowrap datatable">
                      ...
                      <tbody>
                        <?php while($pending = $Pending->fetch(PDO::FETCH_ASSOC)){?>
                        <tr>
                          <td><input class="form-check-input m-0 align-middle" type="checkbox" aria-label="Select invoice"></td>
                          <td><span class="text-muted"><?=$pending['user_id']?></span></td>
                          <td><a href="view-kyc-doc.php?id=<?=$pending['user_id']?>" class="text-reset" tabindex="-1"><?=$pending['Owner_Name']?></a></td>
                          <td>
                          <?=$pending['owner_province']?>
                          </td>
                          <td>
                            <?=$pending['owner_city']?>
                          </td>
                          <td>
                            <span class="badge bg-success me-1"></span><?=$pending['owner_town']?>
                          </td>
                          <td>
                            <?=$pending['nrc_no']?>
                          </td>
                          <td class="text-end">
                            <span class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item" href="view-kyc-doc.php?id=<?=$pending['user_id']?>">
                                  View
                                </a>
                              </div>
                            </span>
                  ...
                  <div class="card-footer d-flex align-items-center">
                    <p class="m-0 text-muted">Showing <span>Pending Property Owner</span> entries</p>
