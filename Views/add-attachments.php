                	...
                	<form method="POST" enctype="multipart/form-data">
						<div class="row" style="margin-left: 1em; margin-right: 1em; margin-top:1em;">
							<div class="mb-3 col-md-6">
								<div class="form-group">
									<img src="dist/img/Group6.png" style="width:320px;" alt="">
								</div>
							</div>
							<div class="mb-3 col-md-6">
								<div class="form-group">
									<label class="form-label">NOTE</label>
									<p>InEight Document controls who can upload documents to the system by a flexible 
									system of Document Rules. Upload Rules are defined in terms of key document attributes 
									and companies are allocated to one or more rule sets meaning that they can only upload 
									documents that conform to the rules of the rule set they have been assigned to.</p>
								</div>
							</div>
						</div>
						<div class="row" style="margin-left: 1em; margin-right: 1em; margin-top:1em;">
							<div class="mb-3 col-md-6">
								...
								<input type="text" class="form-control" value="<?=$_SESSION['last_id']?>" name="example-text-input">
							</div>
							<div class="mb-3 col-md-6">
						...
						<div class="card-footer text-end">
							<div class="d-flex">
								...
								<button type="submit" name="upload_documents" class="btn btn-primary ms-auto">Attach Images</button>
							</div>
						</div>
                  	</form>                  
                </div>
