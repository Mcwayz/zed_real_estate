...
$Pending = $Admin->getNotApprovedOwners();
?>
  <body >
    <div class="wrapper">
            ...
            <div class="row row-deck row-cards">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">Property for Sale</div>
                    ...
                    <?php
                      $All = $Admin->countSaleProperty();
                      $Sale = $All->fetch(PDO::FETCH_ASSOC);
                    ?>
                    <div class="h1 mb-3"><?=$Sale['properties']?></div>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">Property for Rent</div>
                      <div class="ms-auto lh-1">
                        <div class="dropdown">
                          <a class="dropdown-toggle text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Last 7 days</a>
                          <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <?php
                      $Rent=$Admin->countRentProperty();
                      $rent=$Rent->fetch(PDO::FETCH_ASSOC);
                    ?>
                    <div class="d-flex align-items-baseline">
                      <div class="h1 mb-0 me-2"><?=$rent['properties']?></div>
                      <div class="me-auto">
                        <span class="text-green d-inline-flex align-items-center lh-1">
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body">
                    ...
                    <?php
                      $Users=$Admin->countTotalUsers();
                      $user=$Users->fetch(PDO::FETCH_ASSOC);
                    ?>
                    <div class="d-flex align-items-baseline">
                      <div class="h1 mb-3 me-2"><?=$user['total_users']?></div>
                      <div class="me-auto">
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">Total Properties</div>
                      <div class="ms-auto lh-1">
                        <div class="dropdown">
                          <a class="dropdown-toggle text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Last 7 days</a>
                          <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <?php
                      $Prop=$Admin->countProperty();
                      $property=$Prop->fetch(PDO::FETCH_ASSOC);
                    ?>
                    <div class="d-flex align-items-baseline">
                      <div class="h1 mb-3 me-2"><?=$property['properties']?></div>
                      <div class="me-auto">
                        <span class="text-green d-inline-flex align-items-center lh-1">
              ...
              <div class="col-lg-12">
                <div class="row row-cards">
                  <div class="col-12">
                    <div class="card">
                      <div class="card-body">
                        <h3 class="card-title">Transactions (Monthly)</h3>
              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-header border-0">
                    <div class="card-title">Onboarded Users</div>
                  </div>
                  <div class="position-relative">
                    <div class="position-absolute top-0 left-0 px-3 mt-1 w-75">
                      <div class="row g-2">
                        ...
                        ?>
                        <div class="col">
                          <div>Users: <?=$user['total_users']?></div>
    ...
    <?php 
				$arr=[$rent['properties'], $Sale['properties'], $property['properties']];
		?>
    <!-- Libs JS -->
      ...
      document.addEventListener("DOMContentLoaded", function () {
        var dataArray = [<?php echo implode(',',$arr); ?>];
      	window.ApexCharts && (new ApexCharts(document.getElementById('chart-mentions'), {
      		...
      		labels: [
      			'2022-11-20', '2022-11-21', '2022-11-22', '2022-11-23', '2022-11-24', '2022-11-25', '2022-11-26', '2022-11-27', '2022-11-28'
      		],
