                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="./admin-view-owner.php" >
                            View Property Owners
                            </a>
                            <a class="dropdown-item" href="./admin-view-clients.php" >
                            View Clients
                            </a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="./admin-view-rent.php" >
                            Rentals Paid
                            </a>
                            <a class="dropdown-item" href="./admin-view-buy.php" >
                            Property Bought
                            </a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#navbar-extra" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false" >
                            <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/chart-candle -->
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="./admin-analyitics.php" >
                            Property Analyitics
                            </a>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" >
                            <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/star -->
                                <!-- Download SVG icon from http://tabler-icons.io/i/messages -->
