        ...
        <div class="navbar navbar-light">
            <div class="container-xl">
                <ul class="navbar-nav">
                    ...
                    <a class="nav-link" href="./dashboard-property-owner.php" >
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="./property-owner-view-rent.php" >
                            Rentals Paid
                            </a>
                            <a class="dropdown-item" href="./property-owner-view-bought.php" >
                            Property Bought
                            </a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="./property-owner-analytics.php" >
                            Property Analyitics
                            </a>
                        </div>
                    </li>
